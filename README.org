...
#+CAPTION: PDF with lots of metadata & fonts@@html:<a href="#fn:0" class="footnote-ref" role="doc-noteref">⁰</a>@@
[[file:images/pdffontetc-screenshot01.png]]

#+CAPTION: same PDF, showing end of fonts & interpretation key
[[file:images/pdffontetc-screenshot02.png]]

#+CAPTION: a different PDF, generated in some horrible way
